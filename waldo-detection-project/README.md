...
<div align="center">
  <img src="assets/training_results/results.png" alt="Training Results" width="800"/>
  <p><i>Training and validation metrics over 40 epochs</i></p>
</div>

<div align="center">
  <img src="assets/training_results/confusion_matrix.png" alt="Confusion Matrix" width="500"/>
  <p><i>Confusion matrix showing 114 correct detections, 32 background detections</i></p>
</div>

<div align="center">
  <img src="assets/training_results/PR_curve.png" alt="Precision-Recall Curve" width="500"/>
...
│   │   └── create_synthetic_advanced.py  # Advanced augmentation with transforms
│   │
│   ├── preprocessing/                # Data preprocessing
│   │   ├── __init__.py
│   │   ├── extract_waldo.py              # CLIP-based Waldo extraction
│   │   ├── generate_labels.py            # Auto-generate YOLO labels from circles
│   │   ├── manual_annotation.py          # Manual bbox annotation tool
│   │   ├── create_backgrounds.py         # Inpainting to remove Waldo
│   │   ├── create_masks.py               # Generate inpainting masks
...
│   │   ├── __init__.py
│   │   ├── detect_single.py              # Single image detection
│   │   ├── detect_folder.py              # Batch processing
│   │   ├── detect_large_images.py        # Tiled detection for large images
│   │   └── detect_with_clip.py           # YOLO + CLIP pipeline
│   │
│   └── utils/                        # Utility functions
│       ├── __init__.py
│       ├── image_utils.py                # Image processing helpers
│       ├── detection_utils.py            # Detection merging & NMS
│       └── visualization.py              # Drawing bboxes and results
│
├── data/                             # Data directory (not in git)
│   ├── raw/                          # Original images
│   ├── annotated/                    # Manually annotated images
